                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('drugstore_address') ? 'has-error' : '' }}">
                                <label class="control-label">Drugstore Address</label> {!! Form::text('drugstore_address', $data->drugstore_address, ['class' => 'form-control']) !!} @if($errors->has('drugstore_address'))
