                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('contact_number') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="contact_number" class="form-control"> @if($errors->has('email'))
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('drugstore') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="drugstore" class="form-control"> @if($errors->has('drugstore'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('drugstore_address') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="drugstore_address" class="form-control"> @if($errors->has('drugstore_address'))
