                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('weight') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="weight" class="form-control"> @if($errors->has('weight'))
                                    <span class="help-block">{{ $errors->first('weight') }}</span> @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('height') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="height" class="form-control"> @if($errors->has('height'))
                                    <span class="help-block">{{ $errors->first('height') }}</span> @endif
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('bloodpressure') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="bloodpressure" class="form-control"> @if($errors->has('bloodpressure'))
                                    <span class="help-block">{{ $errors->first('bloodpressure') }}</span> @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('temperature') ? 'has-error' : '' }}">
                                    ...
                                    <span style="color: red">*</span>
                                    <input type="text" name="temperature" class="form-control"> @if($errors->has('temperature'))
                                    <span class="help-block">{{ $errors->first('temperaturee') }}</span> @endif
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('pulserate') ? 'has-error' : '' }}">
                                    ...
                                    <span style="color: red">*</span>
                                    <input type="text" name="pulserate" class="form-control"> @if($errors->has('pulserate'))
                                    <span class="help-block">{{ $errors->first('pulserate') }}</span> @endif
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('resprate') ? 'has-error' : '' }}">
                                    ...
                                    <span style="color: red">*</span>
                                    <input type="text" name="resprate" class="form-control"> @if($errors->has('resprate'))
                                    <span class="help-block">{{ $errors->first('resprate') }}</span> @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('patientnote') ? 'has-error' : '' }}">
                                    ...
                                    <span style="color: red">*</span>
                                    <input type="text" name="patientnote" class="form-control"> @if($errors->has('patientnote'))
                                    <span class="help-block">{{ $errors->first('patientnote') }}</span> @endif
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('allergyname') ? 'has-error' : '' }}">
                                    ...
                                    <span style="color: red">*</span>
                                    <input type="text" name="allergyname" class="form-control"> @if($errors->has('allergyname'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('allergyquestion') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="allergyquestion" class="form-control"> @if($errors->has('allergyquestion'))
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('pastsakit') ? 'has-error' : '' }}">
                                    ...
                                    <span style="color: red">*</span>
                                    <input type="text" name="pastsakit" class="form-control"> @if($errors->has('pastsakit'))
                                    <span class="help-block">{{ $errors->first('pastsakit') }}</span> @endif
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('immunization') ? 'has-error' : '' }}">
                                    <label class="control-label">immunization</label>
                                    <input type="text" name="immunization" class="form-control"> @if($errors->has('immunization'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('surgeryprocedure') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="surgeryprocedure" class="form-control"> @if($errors->has('surgeryprocedure'))
                                    <span class="help-block">{{ $errors->first('surgeryprocedure') }}</span> @endif
                                </div>
                            </div>
                        </div>
                        <!-- trainging -->
