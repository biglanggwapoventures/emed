        ...
        <div class="col-md-9 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <img alt="User Pic" src="{{ " /storage/{$data->userInfo->avatar}" }}" style="width: 150px; height: 150px;" class="img-circle img-responsive"> {!! Form::open(['url' => route('upload.dp'), 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!} {!! Form::hidden('id', $data->userInfo->id) !!} @elseif(Auth::user()->user_type === 'SECRETARY')
