                        ...
                        <div class="row">
                             <div class="col-md-4">
                                <div class="form-group {{ $errors->has('bloodtype') ? 'has-error' : '' }}">
                                    ...
                                    <span style="color: red">*</span>
                                    <input type="text" name="bloodtype" class="form-control"> @if($errors->has('bloodtype'))
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('ptr') ? 'has-error' : '' }}">
                                    ...
                                    <span style="color: red">*</span>
                                    <input type="text" name="ptrc" class="form-control"> @if($errors->has('ptr'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('prc') ? 'has-error' : '' }}">
                                    ...
                                    <span style="color: red">*</span>
                                    <input type="text" name="prc" class="form-control"> @if($errors->has('prc'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('s2') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="s2" class="form-control"> @if($errors->has('s2'))
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('specialization') ? 'has-error' : '' }}">
                                    ...
                                    <span style="color: red">*</span>
                                    <input type="text" name="specialization" class="form-control"> @if($errors->has('specialization'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                    ...
                                    <span style="color: red">*</span>
                                    <input type="text" name="title" class="form-control" placeholder="eg. MD, MS, GP, OB/GYN"> @if($errors->has('specialization'))
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('clinic') ? 'has-error' : '' }}">
                                    ...
                                    <span style="color: red">*</span>
                                    <input type="text" name="clinic" class="form-control"> @if($errors->has('clinic'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('clinic_address') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="clinic_address" class="form-control"> @if($errors->has('clinic_address'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('consultation_hours') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="consultation_hours" class="form-control"> @if($errors->has('consultation_hours'))
                                    <span class="help-block">{{ $errors->first('consultation_hours') }}</span> @endif
                                </div>
                            </div>
