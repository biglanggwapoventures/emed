          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <!-- /.tab-pane -->
               ...
               <div class="active tab-pane" id="doctor">
               ...
               <div class="active tab-pane" id="consultation">
               
                 <table id="example3" class="table table-bordered table-striped">
                  <a href="{{ route('consultations.index', ['patient_id' =>  $patients->id]) }}" class="btn btn-info pull-left"><span class="glyphicon glyphicon-plus"></span> Consultation</a>
                <thead>
                            <tr class="active">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('prescription.index', ['patient_id' => $patients->id, 'consultation_id' => $a->id]) }}" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span></a>
